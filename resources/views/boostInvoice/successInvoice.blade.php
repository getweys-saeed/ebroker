                ...
                <div class="row">
                    <div class="col-12">
                        <table class="table table-striped" id="table_list" data-toggle="table"
                            data-url="{{ url('listBoostPropertyInvoicesSuccess') }}" data-click-to-select="true"
                            ...
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th scope="col" data-field="name" data-align="center" data-sortable="true">
                                        ...
                                        <th scope="col" data-field="payment_screenshot" data-formatter="imageFormatter" data-align="center" data-sortable="false">
                                            {{ __('ScreenShot') }}
                                        </th>
                                    <th scope="col" data-field="order_id"  data-align="center" data-sortable="false">
                                        {{ __('Order Id') }}
                                    </th>
                                    <th scope="col" data-field="ispayed" data-align="center" data-formatter="booststatusFormator" data-sortable="false">
                                        {{ __('Payment') }}
                                    </th>
