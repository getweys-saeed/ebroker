...
function enableDisableSwitchFormatter(value, row) {
    ...
    return `<div class="form-check form-switch" style="padding-left: 5.2rem;">
        ...
        function imageFormatter(value, row) {
            return `<img src="${row.user_document}" alt="Document" class="img-thumbnail" style="width: 100px; height: 100px; cursor: pointer;" onclick="showImageModal('${row.user_document}')">`;
        }
