...
@section('script')
    ...
    return value == 1 ? '<span class="bg-success p-2 rounded-1 text-light fw-bold">Approved</span>' : '<span class="bg-danger p-2 rounded-1 text-light fw-bold">Unproved</span>';
}
