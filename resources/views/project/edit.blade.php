...
@endsection
@section('content')
    {!! Form::open(['route' => 'project.update', 'data-parsley-validate', 'id' => 'myForm', 'files' => true]) !!}
    <div class='row'>
        <div class='col-md-6'>
            <div class="card">
                {{-- Category --}}
                <div class="card-body">
                    ...
                    <div class="col-md-12 col-12 form-group mandatory">
                        ...
                        {{ Form::text('title', isset($project->title) ? $project->title : '', [
                            'class' => 'form-control ',
                    ...
                    <div class="col-md-12 col-12 form-group mandatory">
                        ...
                        {{ Form::textarea('description',isset($project->description) ? $project->description : '', [
                    ...
                    <div class="col-md-12 col-12 form-group mandatory">
                        ...
                        {{ Form::text('square_yd', isset($project->square_yd) ? $project->square_yd : '', [
                            'class' => 'form-control ',
                            'name' => 'square_yd',
                    ...
                    <div class="col-md-12 col-12 form-group mandatory">
                        ...
                        <div class="form-check">
                            {{ Form::radio('propery_type', 0,  isset($project->propery_type) ? $project->propery_type : 0, ['class' => 'form-check-input', 'id' => 'commercial']) }}
                            <label class="form-check-label" for="commercial">{{ __('Commercial') }}</label>
                        </div>

                        <div class="form-check">
                            {{ Form::radio('propery_type', 1, isset($project->propery_type) ? $project->propery_type : 1, ['class' => 'form-check-input', 'id' => 'residential']) }}
                    ...
                    <div class="control-label col-12 form-group mt-2 mandatory">
                        ...
                        {{ Form::number('price', isset($project->price) ? $project->price : '', [
                ...
                <div class="row card-body">
                    ...
                    <div class="col-md-6 col-sm-12 form-group card">
                        ...
                        @if ($project->meta_image)
                            <div class="mt-3">
                                <img src="{{ asset('storage/' . $project->meta_image) }}" alt="Current Image" style="max-width: 100%; height: auto;">
                            </div>
                        @endif
