                        ...
                        <div class="col-sm-12 col-md-12 form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-4 form-group mandatory ">
                                    ...
                                    {{ Form::text('code', '', [
                                        'class' => 'form-control',
                                        'placeholder' => trans('Language Code'),
                                        'data-parsley-required' => 'true',
                                    ]) }}
                            ...
                            <div class="col-sm-12 mt-2">
                                <div class="col-md-12 col-12">
                                    <div class="form-group mandatory">
                                        ...
                                        <input type="text" id="edit_language_code" class="form-control col-12" placeholder="{{ __('Language Code') }}" name="edit_language_code" data-parsley-required="true">
                                    </div>
                                </div>
