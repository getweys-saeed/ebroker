    ...
    <section class="section">
        <form class="form" action="{{ route('notification-setting-store') }}" method="POST" enctype="multipart/form-data" data-parsley-validate>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        @else
                                            <div class="col-sm-12 col-lg-6 form-group">
                                                {{ Form::label('service-json-file', __('Service JSON File'), ['class' => 'form-label']) }}
                                                {{ Form::file('firebase_service_json_file', ['class' => 'form-control', 'data-parsley-required' => 'true', 'accept' => '.json']) }}
                                                <div class="mt-2">
            ...
            <div class="col-12 d-flex justify-content-end">
                <button type="submit" name="btnAdd1" value="btnAdd" id="btnAdd1" class="btn btn-primary me-1 mb-1">Save</button>
            </div>
        </form>
    </section>
@endsection
