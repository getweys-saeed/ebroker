                    ...
                    <table class="table table-striped" id="table_list"
                        ...
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th scope="col" data-field="subject" data-sortable="true" data-align="center">{{ __('Subject') }}</th>
                                <th scope="col" data-field="message" data-sortable="true" data-align="center">{{ __('Message') }}</th>
                            </tr>
                        </thead>
                    </table>
                </div>
