            ...
            <div class="card-body">
                <div class="row " id="toolbar">
                    <div class=" col-12 col-md-6 col-sm-12  col-lg-6">
                        <select id="statusBoost" class="form-select" >
                    ...
                    {{-- Filter Status --}}
                    <div class=" col-12 col-md-6 col-sm-12  col-lg-6">
                        <select id="statusPay" class="form-select" >
                            <option value="" selected>{{ __('Select Status') }}</option>
                            <option value="0">{{ __('Easy Paisa') }}</option>
                            <option value="1">{{ __('Jazz Cash') }}</option>
                ...
                <div class="row">
                    <div class="col-12">
                        <table class="table table-striped" id="table_list" data-toggle="table"
                            data-url="{{ url('listPropertiesAnalytics') }}" data-click-to-select="true"
                            ...
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th scope="col" data-field="price" data-align="center" data-sortable="true">
                                        {{ __('Price') }}</th>
                                        <th scope="col" data-field="views" data-align="center" data-sortable="true">
                                            {{ __('views') }}</th>
                                            <th scope="col" data-field="impressions" data-align="center" data-sortable="true">
                                                {{ __('impressions') }}</th>
...
@section('script')
    <script>
        ...
        $('#statusBoost').on('change', function() {
            $('#table_list').bootstrapTable('refresh');
        });

        $('#statusPay').on('change', function() {
            $('#table_list').bootstrapTable('refresh');
        });
        ...
        function queryParams(p) {
            return {
                ...
                limit: p.limit,
                search: p.search,
                boost: $('#statusBoost').val(),
                payment: $('#statusPay').val(),
            };
        }
